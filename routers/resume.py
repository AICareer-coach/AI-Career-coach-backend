...
async def upload_and_process_resume(
    ...
    skip_analysis: bool = Form(False, description="Set to true to skip the full AI analysis report generation."),
    ...
    Also performs a full resume analysis including ATS if a job description is provided AND skip_analysis is False.
    """
    uid = user['uid']
    ...
    try:
        ...
        # --- Conditional Full Resume Analysis ---
        if skip_analysis:
            # If the flag is true (e.g., from profile page), skip analysis and return.
            print(f"DEBUG: Skipping full analysis report generation for user {uid} as requested.")
            return JSONResponse(content={
                "message": "Resume processed and saved successfully!",
                "user_uid": uid,
            })
        else:
            # Original behavior: generate the full report for the main optimizer page.
